      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">
           <div>
            <?= Html::a('<i class="fa fa-plus-circle"></i> สร้างประเภทสินค้า', ['create'], ['class' => 'btn btn-success']) ?>
                        ...
                        'value' => function($model){
                                return '
                                    <div class="btn-group" >
                                        ...
                                        <li><a href="'.Url::toRoute(['/producttype/view', 'id'=>$model->id]).'">'.'View'.'</a></li>
                                        <li><a href="'.Url::toRoute(['/producttype/update', 'id'=>$model->id]).'">'.'Update'.'</a></li>
                                        <li><a onclick="return confirm(\'Confirm ?\')" href="'.Url::to(['/producttype/delete', 'id'=>$model->id],true).'">Delete</a></li>
                                        </ul>
                                    </div>
                                ';
                            // }
